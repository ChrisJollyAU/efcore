...
/// </summary>
public class SqlServerLiftOrderByPostprocessor : ExpressionVisitor
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public SqlServerLiftOrderByPostprocessor(
            ...
            case SelectExpression selectExpression:
                {
                        ...
                        else
                        {
                            ...
                            if (existingIndex != -1)
                            {
                                bool referouter = sqlExpression is ColumnExpression colexp1 &&
                                    selectExpression.Tables.Select(t => t.Alias).Contains(colexp1.TableAlias);
                    ...
                    if (selectExpression.Limit != null || selectExpression.Offset != null)
                    {
                        ...
                        if (offset != null)
                        {
                            selectExpression.ApplyOffset(offset);
                        }
                    }
                    else
                    {
